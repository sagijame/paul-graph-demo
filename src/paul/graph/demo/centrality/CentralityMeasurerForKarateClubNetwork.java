...
public class CentralityMeasurerForKarateClubNetwork {
	...
	public static void main(String[] args) {
		...
		try {
			g = reader.readGraph(DIR_PATH + "karate_club_gephi.graphml");
		...
		try {
			writer.writeGraph(g, DIR_PATH + "karate_club_centrality.graphml");
		} catch (DataIOException e) {
			e.printStackTrace();
		}
